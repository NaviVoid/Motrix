...
export const PORTABLE_EXECUTABLE_DIR = globalThis.process?.env?.PORTABLE_EXECUTABLE_DIR
...
interface TrackerSourceGroup {
  label: string
  options: TrackerOption[]
}

export const TRACKER_SOURCE_OPTIONS: TrackerSourceGroup[] = [
  {
...
export const PROXY_SCOPE_OPTIONS: string[] = [
...
export const COMMON_RESOURCE_TAGS: string[] = ['http://', 'https://', 'ftp://', 'magnet:']
export const THUNDER_RESOURCE_TAGS: string[] = ['thunder://']

export const RESOURCE_TAGS: string[] = [
  ...COMMON_RESOURCE_TAGS,
  ...THUNDER_RESOURCE_TAGS
]

export const SUPPORT_RTL_LOCALES: string[] = [
  /* 'العربية', Arabic */
  'ar',
  /* 'فارسی', Persian */
  'fa',
...
export const IMAGE_SUFFIXES: string[] = [
  '.ai',
  '.bmp',
  '.eps',
  '.fig',
...
export const AUDIO_SUFFIXES: string[] = [
  '.aac',
  '.ape',
  '.flac',
  '.flav',
...
export const VIDEO_SUFFIXES: string[] = [
  '.avi',
  '.m4v',
  '.mkv',
  '.mov',
...
export const SUB_SUFFIXES: string[] = [
  '.ass',
  '.idx',
  '.smi',
  '.srt',
...
export const DOCUMENT_SUFFIXES: string[] = [
  '.azw3',
  '.csv',
  '.doc',
  '.docx',
